...
const Careercards = () => {
  ...
  const items = [
    {
      ...
      description:
        ...
        icon: require("../image/client4.jpg"),
    },
    {
      title: "Walking",
      description:
      ...
      icon: require("../image/client2.jpg"),
    },
    {
      title: "Weights",
      description:
      ...
      icon: require("../image/client3.jpg"),
    },
  ];
  ...
  return (
    <div className="career-card-carousel">
      <div
        className="inner"
      ...
      >
        {items.map((item) => {
          return <Careeritem item={item} width={"100%"} />;
        })}
      </div>
